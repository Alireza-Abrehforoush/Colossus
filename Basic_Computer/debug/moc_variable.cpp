...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Variable_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject Variable::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Variable.data,
    qt_meta_data_Variable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Variable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Variable.stringdata0))
